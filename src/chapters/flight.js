  ...
  get pages() {
    ...
    return [
      <div>
        ...
        <p>“Why are all those people all {this.getOne('activities', 1)}?” wondered {person(0)}.</p>
      </div>
    ,
      <div>
        <p>Suddenly, the land below the {friendCount} friends disappeared, and they were flying over a great sea.</p>
        <p>On and on the majestic bird flew.</p>
        <p>{person(1)} clutched tightly onto the {object(0)}, afraid that it might fall.</p>
      </div>
    ,
      <div>
    ...
    ,
      <div>
        ...
        <p className="trello-hint">Tick `{this.props.title}` to go to the next chapter</p>
      </div>
    ];
  }
}
